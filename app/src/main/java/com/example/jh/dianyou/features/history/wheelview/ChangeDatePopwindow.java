package com.example.jh.dianyou.features.history.wheelview;
...
import com.example.jh.dianyou.features.history.wheelview.adapter.AbstractWheelTextAdapter1;
...
public class ChangeDatePopwindow extends PopupWindow implements View.OnClickListener {
	...
	public ChangeDatePopwindow(final Context context) {
		...
		final View view=View.inflate(context, R.layout.dialog_myinfo_changebirth,null);
...
//		bgtext.setText(getYear());
		...
		mMonthAdapter = new CalendarTextAdapter(context, arry_months, Integer.parseInt(currentMonth), maxTextSize, minTextSize);
		wvMonth.setVisibleItems(5);
		wvMonth.setViewAdapter(mMonthAdapter);
		wvMonth.setCurrentItem(setMonth(month));
		...
		wvDay.setCurrentItem(Integer.parseInt(day) - 1);
	...
	public void onClick(View v) {
		...
		if (v == btnSure) {
			if (onBirthListener != null) {
				...
				Log.d("Taog", "" + selectYear + "" + selectMonth + "" + selectDay);
			}
			dismiss();
		} else if (v == btnCancel) {
			dismiss();
